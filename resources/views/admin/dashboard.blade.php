            ...
            <div class="p-5 bg-white rounded-xl border border-gray-100 shadow card-hover">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600 mt-1">1,420</p>
            ...
            <div class="p-5 bg-white rounded-xl border border-gray-100 shadow card-hover">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 mt-1">$34,900</p>
            ...
            <div class="p-5 bg-white rounded-xl border border-gray-100 shadow card-hover">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-purple-600 mt-1">278</p>
