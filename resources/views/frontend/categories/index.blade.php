...
<div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
    <h1 class="text-4xl md:text-5xl font-extrabold text-center mb-12 text-gray-900 animate__animated animate__fadeIn animate__delay-1s">
        ...
        @forelse($categories as $category)
            <a href="{{ route('categories.show', $category->slug) }}"
               class="relative p-8 bg-white shadow-xl rounded-xl group overflow-hidden transition transform hover:scale-[1.01] hover:shadow-2xl hover:ring-1 hover:ring-blue-100">
                ...
                <h2 class="text-2xl font-semibold text-blue-700 group-hover:text-blue-800 relative z-10 transition-colors duration-300">
                    {{ $category->name }}
                </h2>
